...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Nombre de course par jour : </div>
					<div class="panel-body">
						...
						<div class="con1">
								 <div class="key_1" > </div>
					             <span class="key_1_1" > Courses Confirmé </span>
						</div>
						<div class="con2">
							<div class="key_2" > </div>
							<span class="key_2_2" > Courses Annulé </span>
						</div>
					</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Course par mois :</div>
					<div class="panel-body">
						<div class="canvas-wrapper">
