...
<title>AjiTaxi - [Chauffeurs]</title>
...
<body>
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#"><span>AjiTaxi</span>Adminstration</a>
        <ul class="user-menu">
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      ...
      <li class="active"><a href="chauffeurs.php"><span class="glyphicon glyphicon-list-alt"></span> Chauffeurs</a></li>
      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-body">
			<input class="form-control" placeholder="Chercher chauffeur" type="text" id="btn_find">
            <button id="btnAdd" >Ajouter un chauffeur</button>
            <br><br>
            <table id="grid"></table>
            <div id="dialog" style="display:none">
              ...
              <table border="0">
                ...
                <tr>
                  <td><label for="numTaxi">Numéro Taxi :</label></td>
                  <td><input type="number" id="numTaxi"></td>
                </tr>
                <tr>
                  <td><label for="matTaxi">Matricule Taxi :</label></td>
                  <td><input type="text" id="matTaxi"></td>
                </tr>
                <tr>
                  <td><label for="marTaxi">Marque Taxi :</label></td>
                  <td><input type="text" id="marTaxi"></td>
                </tr>
                <tr>
  ...
  <script type="text/javascript" src="js/script-datatable.js" charset="utf-8"></script>
</body>
